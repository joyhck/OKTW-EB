...
namespace LeeSin
{
    public static class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Menu = MainMenu.AddMenu("Lee Sin", "blindboy");
            Menu.AddLabel("Ported from El Lee Sin - Berb");

            Menu.AddSeparator();

            Menu.AddGroupLabel("Combo");
            Menu.Add("ElLeeSin.Combo.Q", new CheckBox("Use Q"));
            Menu.Add("ElLeeSin.Combo.Q2", new CheckBox("Use Q2"));
            Menu.Add("ElLeeSin.Combo.W2", new CheckBox("Use W"));
            Menu.Add("ElLeeSin.Combo.E", new CheckBox("Use E"));
            Menu.Add("ElLeeSin.Combo.R", new CheckBox("Use R"));
            Menu.Add("ElLeeSin.Combo.KS.R", new CheckBox("KS R"));

            Menu.Add("ElLeeSin.Combo.New", new CheckBox("Kick multiple targets:"));
            Menu.Add("ElLeeSin.Combo.R.Count", new Slider("R target hit count", 2, 2, 4));
            Menu.Add("ElLeeSin.Combo.PassiveStacks", new Slider("Min Stacks Combo", 1, 1, 2));
            Menu.Add("ElLeeSin.Combo.AAStacks", new CheckBox("Wait for Passive", false));
            Menu.Add("starCombo", new KeyBind("Use Star Combo", false, KeyBind.BindTypes.HoldActive, 'T'));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Insec");
            Menu.Add("InsecEnabled", new KeyBind("Insec :", false, KeyBind.BindTypes.HoldActive, 'A'));
            Menu.Add("ElLeeSin.Insec.UseInstaFlash", new KeyBind("Flash + R :", false, KeyBind.BindTypes.HoldActive, 'U'));
            Menu.Add("insecOrbwalk", new CheckBox("Orbwalking when insec"));
            Menu.Add("ElLeeSin.Insec.Ally", new CheckBox("Insec to allies"));
            Menu.Add("ElLeeSin.Insec.Original.Pos", new CheckBox("Insec to original pos"));
            Menu.Add("insecmouse", new CheckBox("Insec to mouse", false));
            Menu.Add("ElLeeSin.Flash.Insec", new CheckBox("Flash Insec when no ward", false));
            Menu.Add("checkOthers1", new CheckBox("Check for units to Insec", false));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Harass");
            Menu.Add("ElLeeSin.Harass.Q1", new CheckBox("Use Q"));
            Menu.Add("ElLeeSin.Harass.Wardjump", new CheckBox("Use W"));
            Menu.Add("ElLeeSin.Harass.E1", new CheckBox("Use E", false));
            Menu.Add("ElLeeSin.Harass.PassiveStacks", new Slider("Min Stacks on Passive", 1, 1, 2));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Lane Clear");
            Menu.Add("ElLeeSin.Lane.Q", new CheckBox("Use Q"));
            Menu.Add("ElLeeSin.Lane.E", new CheckBox("Use E"));

            Menu.AddSeparator();

            Menu.AddGroupLabel("Jungle Clear");
            Menu.Add("ElLeeSin.Jungle.Q", new CheckBox("Use Q"));
            Menu.Add("ElLeeSin.Jungle.W", new CheckBox("Use W"));
            Menu.Add("ElLeeSin.Jungle.E", new CheckBox("Use E"));
            Menu.Add("junglePassive", new CheckBox("Passive Control in jungle", false));
            ...
            Menu.Add("ElLeeSin.Combo.W", new CheckBox("Wardjump in combo", false));
            Menu.Add("ElLeeSin.Combo.Mode.WW", new CheckBox("Out of AA range - Wardjump", false));
