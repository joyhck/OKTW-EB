...
namespace SPrediction
{
    ...
    public static class StasisPrediction
    {
        ...
        private static List<LeagueSharp.Common.Spell> s_RegisteredSpells;
        ...
        public static void Initialize()
        {
            ...
            s_RegisteredSpells = new List<LeagueSharp.Common.Spell>();
        ...
        public static void RegisterSpell(LeagueSharp.Common.Spell s)
        {
        ...
        /// </summary>
        /// <param name="s"></param>
        public static void UnregisterSpell(LeagueSharp.Common.Spell s)
        {
            if (s_RegisteredSpells.Contains(s))
        ...
        internal class Stasis
        {
            ...
            internal void Process(LeagueSharp.Common.Spell spell)
            {
                ...
                if (Utils.TickCount - this.StartTick >= this.Duration - arrivalT)
                {
                    ...
                    pred.HitChance = LeagueSharp.Common.HitChance.VeryHigh;
                    pred.Lock(false);
                    ...
                    if (OnGuaranteedHit != null && pred.HitChance != LeagueSharp.Common.HitChance.Collision && pred.HitChance != LeagueSharp.Common.HitChance.OutOfRange)
