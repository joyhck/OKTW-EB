...
namespace SPrediction
{
    ...
    public static class SpellExtensions
    {
        ...
        /// <param name="target">Target</param>
        /// <returns>Prediction result as <see cref="Prediction.Result"/></returns>
        public static Prediction.Result GetArcSPrediction(this LeagueSharp.Common.Spell s, AIHeroClient target)
        {
        ...
        public static VectorPrediction.Result GetVectorSPrediction(this LeagueSharp.Common.Spell s, AIHeroClient target, float vectorLenght)
        {
        ...
        /// <returns>Prediction result as <see cref="Prediction.Result"/></returns>
        public static Prediction.Result GetRingSPrediction(this LeagueSharp.Common.Spell s, AIHeroClient target, float ringRadius)
        {
        ...
        /// </summary>
        /// <returns>Prediction result as <see cref="Prediction.Result"/></returns>
        public static Prediction.AoeResult GetAoeSPrediction(this LeagueSharp.Common.Spell s)
        {
            if (s.Collision)
        ...
        /// </summary>
        /// <returns>Prediction result as <see cref="Prediction.Result"/></returns>
        public static Prediction.AoeResult GetAoeArcSPrediction(this LeagueSharp.Common.Spell s)
        {
            if (s.Collision)
                throw new InvalidOperationException("Collisionable spell");
        ...
        public static VectorPrediction.AoeResult GetAoeVectorSPrediction(this LeagueSharp.Common.Spell s, float vectorLenght)
        {
            if (s.Collision)
                throw new InvalidOperationException("Collisionable spell");
        ...
        public static bool CheckCollision(this LeagueSharp.Common.Spell s, Vector2 to, bool checkMinion = true, bool checkEnemyHero = false, bool checkYasuoWall = true, bool checkAllyHero = false, bool checkWall = false, bool isArc = false)
        {
        ...
        /// <param name="isArc">Checks collision for arc spell</param>
        /// <returns>true if collision found</returns>
        public static bool CheckMinionCollision(this LeagueSharp.Common.Spell s, Vector2 to, bool isArc = false)
        {
        ...
        /// <param name="isArc">Checks collision for arc spell</param>
        /// <returns>true if collision found</returns>
        public static bool CheckEnemyHeroCollision(this LeagueSharp.Common.Spell s, Vector2 to, bool isArc = false)
        {
        ...
        /// <param name="isArc">Checks collision for arc spell</param>
        /// <returns>true if collision found</returns>
        public static bool CheckAllyHeroCollision(this LeagueSharp.Common.Spell s, Vector2 to, bool isArc = false)
        {
        ...
        /// <param name="to">End position</param>
        /// <returns>true if collision found</returns>
        public static bool CheckWallCollision(this LeagueSharp.Common.Spell s, Vector2 to)
        {
        ...
        /// <returns>true if collision found</returns>
        public static bool CheckYasuoWallCollision(this LeagueSharp.Common.Spell s, Vector2 to, bool isArc = false)
        {
        ...
        /// <param name="isArc">Check collision for arc spell</param>
        /// <returns>true if collision found</returns>
        public static Collision.Flags GetCollisionFlags(this LeagueSharp.Common.Spell s, Vector2 from, Vector2 to, bool isArc = false)
        {
        ...
        public static Collision.Result GetCollisions(this LeagueSharp.Common.Spell s, Vector2 to, bool isArc = false)
        {
        ...
        public static bool SPredictionCast(this LeagueSharp.Common.Spell s, AIHeroClient t, LeagueSharp.Common.HitChance hc, int reactionIgnoreDelay = 0, byte minHit = 1, Vector3? rangeCheckFrom = null, float filterHPPercent = 100)
        {
            ...
            if (!s.IsSkillshot)
                return s.Cast(t) == LeagueSharp.Common.Spell.CastStates.SuccessfullyCasted;
        ...
        /// <param name="filterHPPercent">Minimum HP Percent to cast (for target)</param>
        /// <returns>true if spell has casted</returns>
        public static bool SPredictionCastArc(this LeagueSharp.Common.Spell s, AIHeroClient t, LeagueSharp.Common.HitChance hc, bool arconly = true, int reactionIgnoreDelay = 0, byte minHit = 1, Vector3? rangeCheckFrom = null, float filterHPPercent = 100)
        {
            if (ConfigMenu.SelectedPrediction == 1)
        ...
        /// <param name="filterHPPercent">Minimum HP Percent to cast (for target)</param>
        /// <returns>true if spell has casted</returns>
        public static bool SPredictionCastRing(this LeagueSharp.Common.Spell s, AIHeroClient t, float ringRadius, LeagueSharp.Common.HitChance hc, bool onlyEdge = true, int reactionIgnoreDelay = 0, byte minHit = 1, Vector3? rangeCheckFrom = null, float filterHPPercent = 100)
        {
            if (ConfigMenu.SelectedPrediction == 1)
                throw new NotSupportedException("Vector Prediction not supported in Common prediction");
        ...
        /// <returns></returns>
        public static bool SPredictionCastAoe(this LeagueSharp.Common.Spell s, int minHit)
        {
            if (minHit < 2)
        ...
        /// <param name="minHit">Minimum aoe hits to cast</param>
        /// <returns></returns>
        public static bool SPredictionCastAoeArc(this LeagueSharp.Common.Spell s, int minHit)
        {
            if (minHit < 2)
                throw new InvalidOperationException("Minimum aoe hit count cannot be less than 2");
        ...
        /// <param name="s">The spell.</param>
        /// <param name="fn">The eventhandler.</param>
        public static void UnregisterStasisCallback(this LeagueSharp.Common.Spell s, EventHandler<StasisPrediction.Result> fn)
        {
