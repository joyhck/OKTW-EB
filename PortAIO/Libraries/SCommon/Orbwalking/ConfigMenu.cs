...
namespace SCommon.Orbwalking
{
    public class ConfigMenu
    {
        ...
        public ConfigMenu(Orbwalker instance, Menu menuToAttach)
        {
            ...
            m_Menu.Add("Orbwalking.Root.iExtraWindup", new Slider("Extra Windup Time", 0, 0, 100));
            ...
            m_Menu.Add("Orbwalking.Misc.iLegitPercent", new Slider("Make Me Legit %", 20, 0, 100));
        ...
        {
            get { return getCheckBoxItem("Orbwalking.Misc.blLegitMode") && ObjectManager.Player.GetAttackSpeed() > 1.40f && m_orbInstance.ActiveMode == Orbwalker.Mode.Combo; }
        }
