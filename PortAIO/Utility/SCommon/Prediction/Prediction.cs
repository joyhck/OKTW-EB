...
namespace SCommon.Prediction
{
    ...
    public static class Prediction
    {
        ...
        public struct Input
        {
            ...
            public Input(Obj_AI_Base _target, LeagueSharp.Common.Spell s, Vector3 _from, Vector3 _rangeCheckFrom)
            {
                Target = _target;
                SpellDelay = s.Delay;
        ...
        private static void Unit_OnDash(Obj_AI_Base sender, LeagueSharp.Common.Dash.DashItem args)
        {
